...
var Icon$R = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React.createElement("path", { d: "m22 12.25v10c0 .96-.79 1.75-1.75 1.75h-7.5v-11h-1.5v11h-7.5c-.96 0-1.75-.79-1.75-1.75v-10c0-.41.34-.75.75-.75h18.5c.41 0 .75.34.75.75z", fill: "#d32f2f" }),
        React.createElement("path", { d: "m24 8.75v2.5c0 .96-.79 1.75-1.75 1.75h-20.5c-.96 0-1.75-.79-1.75-1.75v-2.5c0-.96.79-1.75 1.75-1.75h20.5c.96 0 1.75.79 1.75 1.75z", fill: "#f44336" }),
        ...
        React.createElement("path", { d: "m12.001 8.044c-6.898 0-10-3.141-10-5.37 0-1.254.962-2.718 3.672-2.718 4.747 0 6.7 4.728 7.07 7.228.031.216-.032.435-.175.6-.141.165-.349.26-.567.26zm-6.328-6.588c-1.05 0-2.172.32-2.172 1.218 0 1.277 2.233 3.603 7.564 3.849-.451-1.662-1.811-5.067-5.392-5.067z", fill: "#ffc107" }),
        React.createElement("path", { d: "m12.75 13v11h-1.5v-11z", fill: "#ff8f00" }),
        React.createElement("path", { d: "m12.75 7.59v5.41h-1.5v-5.41c0-.229.08-.439.21-.59.14-.15.33-.25.54-.25s.4.1.54.25c.13.15.21.36.21.59z", fill: "#ffc107" }),
        React.createElement("path", { d: "m11.25 13h-9.25v9.25c0 .96.79 1.75 1.75 1.75h7.5z", fill: "#b82929" }),
        React.createElement("path", { d: "m5.966 7h-4.216c-.96 0-1.75.79-1.75 1.75v2.5c0 .96.79 1.75 1.75 1.75h.25 9.25.75-.75v-4.969c-2.152-.074-3.906-.464-5.284-1.031z", fill: "#d43a2f" }),
        React.createElement("path", { d: "m5.673 1.456c-1.05 0-2.172.32-2.172 1.218 0 1.277 2.233 3.603 7.564 3.849-.451-1.662-1.811-5.067-5.392-5.067z", fill: "#dedede" }),
        ...
        React.createElement("path", { d: "m12 13h-.75v11h.75z", fill: "#de7c00" }),
