...
var Icon$R = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
        React__default['default'].createElement("path", { d: "m22 12.25v10c0 .96-.79 1.75-1.75 1.75h-7.5v-11h-1.5v11h-7.5c-.96 0-1.75-.79-1.75-1.75v-10c0-.41.34-.75.75-.75h18.5c.41 0 .75.34.75.75z" }),
        React__default['default'].createElement("path", { d: "m24 8.75v2.5c0 .96-.79 1.75-1.75 1.75h-20.5c-.96 0-1.75-.79-1.75-1.75v-2.5c0-.96.79-1.75 1.75-1.75h20.5c.96 0 1.75.79 1.75 1.75z" }),
        React__default['default'].createElement("path", { d: "m12 8.044c-.218 0-.426-.095-.567-.26-.143-.165-.206-.384-.175-.6.37-2.5 2.323-7.228 7.071-7.228 2.71 0 3.671 1.464 3.671 2.718 0 2.229-3.103 5.37-10 5.37zm6.329-6.588c-3.582 0-4.942 3.405-5.393 5.066 2.826-.132 4.608-.847 5.634-1.456 1.423-.845 1.93-1.79 1.93-2.393 0-.898-1.121-1.217-2.171-1.217z" }),
        React__default['default'].createElement("path", { d: "m12.001 8.044c-6.898 0-10-3.141-10-5.37 0-1.254.962-2.718 3.672-2.718 4.747 0 6.7 4.728 7.07 7.228.031.216-.032.435-.175.6-.141.165-.349.26-.567.26zm-6.328-6.588c-1.05 0-2.172.32-2.172 1.218 0 1.277 2.233 3.603 7.564 3.849-.451-1.662-1.811-5.067-5.392-5.067z" }),
        React__default['default'].createElement("path", { d: "m12.75 13v11h-1.5v-11z" }),
        React__default['default'].createElement("path", { d: "m12.75 7.59v5.41h-1.5v-5.41c0-.229.08-.439.21-.59.14-.15.33-.25.54-.25s.4.1.54.25c.13.15.21.36.21.59z" }),
        React__default['default'].createElement("path", { d: "m11.25 13h-9.25v9.25c0 .96.79 1.75 1.75 1.75h7.5z" }),
        React__default['default'].createElement("path", { d: "m5.966 7h-4.216c-.96 0-1.75.79-1.75 1.75v2.5c0 .96.79 1.75 1.75 1.75h.25 9.25.75-.75v-4.969c-2.152-.074-3.906-.464-5.284-1.031z" }),
        React__default['default'].createElement("path", { d: "m5.673 1.456c-1.05 0-2.172.32-2.172 1.218 0 1.277 2.233 3.603 7.564 3.849-.451-1.662-1.811-5.067-5.392-5.067z" }),
        React__default['default'].createElement("path", { d: "m11.064 6.522c-5.33-.245-7.564-2.571-7.564-3.849 0-.898 1.122-1.218 2.172-1.218 3.582.001 4.942 3.406 5.392 5.067zm-5.391-6.566c-2.71 0-3.672 1.464-3.672 2.718 0 1.422 1.262 3.214 3.965 4.326 1.379.567 3.132.957 5.284 1.031v-.441c0-.229.08-.439.21-.59.14-.15.33-.25.54-.25v-2.115c-.984-2.283-2.948-4.679-6.327-4.679z" }),
        React__default['default'].createElement("path", { d: "m12 13h-.75v11h.75z" }),
        React__default['default'].createElement("path", { d: "m12 6.75c-.21 0-.4.1-.54.25-.13.15-.21.36-.21.59v.441 4.969h.75z" })));
};
